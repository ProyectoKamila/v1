function CPayTablePanel(){
    ...
    this._init = function(){
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text("X"+(5-i),"bold 20px Arial", "#ffffff");
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text("X"+(5-i),"bold 12px Arial", "#ffffff");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text(s_aSymbolWin[0][4-i],"bold 20px Arial", "#041161");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text(s_aSymbolWin[1][4-i],"bold 20px Arial", "#041161");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<4;i++){
            var oText = new createjs.Text(s_aSymbolWin[2][4-i],"bold 21px Arial", "#041161");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<4;i++){
            var oText = new createjs.Text(s_aSymbolWin[3][4-i],"bold 21px Arial", "#041161");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<4;i++){
            var oText = new createjs.Text(s_aSymbolWin[4][4-i],"bold 21px Arial", "#041161");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<4;i++){
            var oText = new createjs.Text(s_aSymbolWin[5][4-i],"bold 21px Arial", "#041161");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<4;i++){
            var oText = new createjs.Text(s_aSymbolWin[6][4-i],"bold 21px Arial", "#041161");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        _oWildText = new createjs.Text(TEXT_HELP_WILD,"24px Arial", "#fff");
