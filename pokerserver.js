...
//                    console.log('Conection ' + connection.idsit + '/' + connection.idsale + ' EnEspera ' + play[connection.idsale].jugadorenespera)
                    if (connection.idsit == play[connection.idsale].jugadorenespera) {
                        ...
                        if (mayorapos == 0){
                            var maxapost = 0;
                            for (i in play[connection.idsale].roomapost) {
                                if (play[connection.idsale].roomapost[i] > maxapost) {
                                    maxapost = parseFloat(play[connection.idsale].roomapost[i]);
                                }
                            }
                            mayorapos = maxapost;
                        }
                        if (mayorapos !== saleonline[connection.idsale][connection.idsit].apos){
