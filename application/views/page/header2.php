...
<div class="container-fluid sin-padding">
     ...
     <div class="container-fluid sin-padding">            
        <div class="row">                
        <div class="col-xs-12">                           
        <div class="menu-movil">                        <ul class="nav nav-pills">
                                        <li role="presentation" class=""><a href="http://www.proyectokamila.com">INICIO</a></li>
                                        <li role="presentation"><a href="http://www.proyectokamila.com/nosotros">NOSOTROS</a></li>	                            
                                        <li role="presentation"><a href="http://www.proyectokamila.com/juego">JUEGOS</a></li>                            
                                        <li role="presentation" class="http://www.proyectokamila.com/poker"><a href="#">PÓKER</a></li>                        
                                        <li role="presentation"><a href="http://www.proyectokamila.com/blog">BLOG</a></li>               
                                    </ul>                    
                                </div>            
                        </div>            
                    </div>        
