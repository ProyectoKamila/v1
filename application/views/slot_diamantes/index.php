...
<html>
    ...
    <body ondragstart="return false;" ondrop="return false;">
        <div class="fondo-game"  style="backfround:#011901;">
...
//var server_url = 'ws://162.252.57.97:8082/';
    ...
    <div id="diamantes" class="container-fluid sin-padding fondo-game hidden-xs" style="background: url(./games/slot-diamantes/game_1024x768/sprites/fondo.jpg) top center;">
                        ...
                        foreach($valores as $v) { ?>
                            ...
                            <div class="col-xs-4">
                                <div class="item-free">
                                    ...
                                    src="./interface/images/diamantes/<?php echo $z; ?>.png"
                                    <?php if($z== 1) { ?>
