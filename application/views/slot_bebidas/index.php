...
<html>
    <head>
        <title>Casino bebidas - Slotmachine bebidas</title>
...
//var server_url = 'ws://162.252.57.97:8082/';
                //socket = new WebSocket('ws://casinobebidas-krondon.c9.io:8082/', 'server'); 
                        ...
                        foreach($valores as $v) { ?>
                            ...
                            <div class="col-xs-4">
                                <div class="item-free">
                                    ...
                                    src="./interface/images/bebidas/<?php echo $z; ?>.png"
                                    <?php if($z== 1) { ?>
