<!--http://localhost/v1/games/slot-ranas/game_1024x768/-->
<!DOCTYPE html>
<html>
    <head>
        <title>Casino 4as - Slotmachine Frutas</title>
        <?php $this->load->view('page/header'); ?>
        <link rel="stylesheet" href="./games/slot-ranas/game_1024x768/css/reset.css" type="text/css">
        <link rel="stylesheet" href="./games/slot-ranas/game_1024x768/css/main.css" type="text/css">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0" />
        <meta name="msapplication-tap-highlight" content="no"/>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/jquery-2.0.3.min.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/createjs-2013.12.12.min.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/ctl_utils.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/sprite_lib.js"></script>
        <!--      <?php // $this->load->view('slotmachine/CSSettings');  ?> -->
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CSlotSettings.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CLang.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CPreloader.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CMain.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CTextButton.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CGfxButton.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CToggle.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CBetBut.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CMenu.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CGame.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CReelColumn.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CInterface.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CPayTablePanel.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CStaticSymbolCell.js"></script>
        <script type="text/javascript" src="./games/slot-ranas/game_1024x768/js/CTweenController.js"></script>


    </head>
    <body ondragstart="return false;" ondrop="return false;"  style="background-color:#007AB4;">
...
//var server_url = 'ws://162.252.57.97:8082/';
    ...
    <div id="ranas" class="container-fluid sin-padding fondo-game" style="background-color:#007AB4;">
