...
<html>
    <head>
        <title>Casino musical - Slotmachine musical</title>
    ...
    <body ondragstart="return false;" ondrop="return false;">
        <div class="fondo-game"  style="background: url(./games/slot-musical/game_1024x768/sprites/bg_game.jpg) top center;">
...
//var server_url = 'ws://162.252.57.97:8082/';
                //socket = new WebSocket('ws://casinomusical-krondon.c9.io:8082/', 'server'); 
    ...
    <div id="musical" class="container-fluid sin-padding fondo-game" style="background: url(./games/slot-musical/game_1024x768/sprites/bg_game.jpg) top center;">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content firstmodal">
                    ...
                    <div class="modal-footer"> 
                         <!-- Casinomusical: Recuerda siempre cerrar sesion si no estas jugando en una maquina de confianza. -->
                        ...
                        foreach($valores as $v) { ?>
                            ...
                            <div class="col-xs-4">
                                <div class="item-free">
                                    ...
                                    src="./interface/images/musical/<?php echo $z; ?>.png"
                                    <?php if($z== 1) { ?>
