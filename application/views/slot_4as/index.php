...
<html>
    <head>
        <title>Casino 4as - Slotmachine 4as</title>
    ...
    <body ondragstart="return false;" ondrop="return false;">
        <div class="fondo-game"  style="background: url(./games/slot-4as/game_1024x768/sprites/bg_game.jpg) top center;">
...
//var server_url = 'ws://162.252.57.97:8082/';
    ...
    <div id="as" class="container-fluid sin-padding fondo-game" style="background: url(./games/slot-4as/game_1024x768/sprites/fondo.jpg) top center;">
                        ...
                        foreach($valores as $v) { ?>
                            ...
                            <div class="col-xs-4">
                                <div class="item-free">
                                    ...
                                    src="./interface/images/4as/<?php echo $z; ?>.png"
                                    <?php if($z== 1) { ?>
