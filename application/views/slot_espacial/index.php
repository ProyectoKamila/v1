<!--http://localhost/v1/games/slot-espacial/game_1024x768/-->
<!DOCTYPE html>
<html>
    <head>
        <title>Casino 4as - Slotmachine espacial</title>
...
//var server_url = 'ws://162.252.57.97:8082/';
    ...
    <div id="espacial" class="container-fluid sin-padding fondo-game" style="background: url('./games/slot-espacial/game_1024x768/sprites/landscape.jpg') no-repeat top center;">
        <div class="carrusel-promo col-xs-offset-4 col-xs-8">
                </div>
        <!-- Trigger the modal with a button -->
        <div class="container sin-padding" style="background: url('./games/slot-espacial/game_1024x768/sprites/landscape.jpg') no-repeat top center;">
            <div class="row">
