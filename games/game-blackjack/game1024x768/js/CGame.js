...
this._onStandPlayer = function(){
    ...
    this._dealing = function(){
        ...
        var dealnode = {
            ...
            _iCardIndexToDeal: _iCardIndexToDeal,
            _aCurActiveCardOffset: _aCurActiveCardOffset.length,
            _iCardDealedToDealer: _iCardDealedToDealer,
