function CPreloader(){
    ...
    this._init = function(){
       ...
       s_oSpriteLibrary.addSprite("bg_preloader","./games/game-blackjack/game1024x768/sprites/bg_preloader.jpg");
       s_oSpriteLibrary.addSprite("progress_bar","./games/game-blackjack/game1024x768/sprites/progress_bar.png");
