function CInterface(){
    ...
    this._init = function(){
        ...
        _oMoneyText = new createjs.Text("","bold 12px Arial", "#fff");
        ...
        _oMsgTitle = new createjs.Text("","bold 20px Digital-7", "#ffde00");
        ...
        _oMsgText = new createjs.Text("","bold 16px Digital-7", "#ffde00");
        ...
        _oClearLastBet = new CTextButton(81,309,s_oSpriteLibrary.getSprite('but_game_bg'),TEXT_CLEAR_LAST_BET,"Arial","#fff",14);
        _oClearLastBet.addEventListener(ON_MOUSE_UP, this._onClearLastBet, this);
        
        _oClearAllBet = new CTextButton(81,342,s_oSpriteLibrary.getSprite('but_game_bg'),TEXT_CLEAR_ALL_BET,"Arial","#fff",14);
        _oClearAllBet.addEventListener(ON_MOUSE_UP, this._onClearAllBet, this);
        
        _oBetVoisinsZero= new CBetTextButton(81,447,s_oSpriteLibrary.getSprite('but_game_bg'),
                                                            TEXT_VOISINS_ZERO,"Arial","#fff",14,"oBetVoisinsZero");
        _oBetVoisinsZero.addEventListener(ON_MOUSE_UP, this._onBetRelease, this);
        
        _oBetOrphelins = new CBetTextButton(81,515,s_oSpriteLibrary.getSprite('but_game_bg'),
                                                            TEXT_ORPHELINS,"Arial","#fff",14,"oBetOrphelins");
        _oBetOrphelins.addEventListener(ON_MOUSE_UP, this._onBetRelease, this);
        
        _oBetTier = new CBetTextButton(81,481,s_oSpriteLibrary.getSprite('but_game_bg'),
                                                            TEXT_TIER,"Arial","#fff",14,"oBetTier");
        _oBetTier.addEventListener(ON_MOUSE_UP, this._onBetRelease, this);
        
        _oBetFinalsBet = new CTextButton(81,582,s_oSpriteLibrary.getSprite('but_game_bg'),TEXT_FINALSBET,"Arial","#fff",14);
        _oBetFinalsBet.addEventListener(ON_MOUSE_UP, this._onFinalBetShow, this);
        
        _oBetNeighbors = new CTextButton(81,549,s_oSpriteLibrary.getSprite('but_game_bg'),TEXT_NEIGHBORS,"Arial","#fff",14);
    ...
    this._onBetRelease = function(oParams){
        ...
        if(aBets !== null){
            s_oGame._onShowBetOnTable({button:oParams.name,numbers:aBets,bet_mult:iBetMult,bet_win:iBetWin,num_fiches:oParams.num_fiches});
        }
    };
