function CHistoryRow(iX,iY){
    ...
    this._init = function(iX,iY){
         ...
         _oRedText = new createjs.Text("a","bold 12px Arial", "#fff");
         ...
         _oGreenText = new createjs.Text("a","bold 12px Arial", "#fff");
         ...
         _oBlackText = new createjs.Text("a","bold 12px Arial", "#fff");
